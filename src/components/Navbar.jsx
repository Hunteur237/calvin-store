      ...
      <motion.header style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 500 }}>
        ...
        <div style={{
          ...
          <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            <div style={{ width: 36, height: 36, borderRadius: 8, overflow: 'hidden', background: `linear-gradient(135deg, ${DS.lime}, ${DS.afro || '#9A3412'})`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            ...
            <div>
              ...
              <div style={{ fontFamily: FONTS.mono, fontSize: '.55rem', color: DS.gray2, letterSpacing: '.16em', textTransform: 'uppercase', marginTop: 2 }}>Tech & Innovation Afrique</div>
            </div>
          </Link>
