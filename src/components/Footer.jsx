          ...
          <div>
            <Link to="/" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, marginBottom: '1.1rem', textDecoration: 'none' }}>
              ...
              <div>
                ...
                <div style={{ fontFamily: FONTS.mono, fontSize: '.55rem', color: DS.gray2, letterSpacing: '.14em', textTransform: 'uppercase', marginTop: 2 }}>Connecter · Communiquer · Avancer</div>
              </div>
            </Link>
