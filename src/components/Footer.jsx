...
const NAV_LINKS = [
  ...
  { label: 'Services & Artisanat', to: '/services' },
...
const SERVICES_LINKS = [
  'Réparation Téléphones/PC', 'Installation Réseaux & Caméras', 'Panneaux Solaires',
  'Maintenance Entreprises', 'Sites & Logiciels', 'Artisanat Africain',
]
      ...
      <div style={{ maxWidth: 1680, width: '100%', margin: '0 auto', padding: '4rem clamp(1.25rem,4vw,3.5rem) 3rem' }}>
        <div style={{
          ...
          <div>
            <Link to="/" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, marginBottom: '1.1rem', textDecoration: 'none' }}>
              <div style={{ width: 34, height: 34, borderRadius: 8, overflow: 'hidden', background: `linear-gradient(135deg, ${DS.lime}, ${DS.afro || '#9A3412'})`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <svg width="24" height="24" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 62 Q50 30 80 62" stroke="#0A0B10" strokeWidth="7" fill="none" strokeLinecap="round"/>
                  <circle cx="50" cy="62" r="7" fill="#0A0B10"/>
                  <text x="50" y="88" textAnchor="middle" fontFamily="Outfit, sans-serif" fontWeight="800" fontSize="20" fill="#0A0B10">CT</text>
                </svg>
              </div>
              <div>
                ...
                <div style={{ fontFamily: FONTS.mono, fontSize: '.55rem', color: DS.gray2, letterSpacing: '.14em', textTransform: 'uppercase', marginTop: 2 }}>Tech & Innovation Afrique</div>
              </div>
            </Link>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          <span style={{ fontFamily: FONTS.mono, fontSize: '.7rem', color: DS.gray, letterSpacing: '.04em' }}>
            © {year} Calvin Telecom. Tous droits réservés. Douala, Cameroun.
          </span>
